...
const Input = ({label, type, name}) => (
    <div className="flex flex-col w-full">
        ...
        <input className="rounded mt-2 mb-6 py-2 px-4 text-primary-800 focus:outline-none" type={type} name={name}
               id={name} required/>
    </div>
)
...
const TextArea = ({label, type, name}) => (
    <div className="flex flex-col w-full">
        <label className="capitalize font-light" htmlFor={name}>{label}</label>
        <textarea className="rounded mt-2 mb-6 py-2 px-4 h-56 text-primary-800 focus:outline-none" type={type}
...
const Contact = () => (
    <div className="w-full dark">
        ...
        <form className="conatainer max-w-4xl mx-auto px-5 py-10 flex flex-col gap-5 items-center" method="post"
